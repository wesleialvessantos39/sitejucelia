...
import { Building2, Lock, ArrowRight, AlertCircle, CheckCircle2 } from 'lucide-react';
...
export default function ResetPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg(err.message || 'Falha ao redefinir a senha. Verifique o link de recuperação.');
    } finally {
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10 px-4">
        <div className="bg-[#0B1526] border border-white/10 rounded-2xl py-8 px-6 sm:px-10 shadow-2xl space-y-6">
          <div className="border-b border-white/5 pb-4">
            <h3 className="text-lg font-bold text-white font-serif">Nova Senha de Acesso</h3>
            <p className="text-xs text-slate-400 mt-1">
              Digite a nova senha que será utilizada no Supabase Auth.
            </p>
          </div>
